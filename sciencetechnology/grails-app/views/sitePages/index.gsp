<g:applyLayout name="mynewlayout">
    ...
    %{--<div class="flex h-full w-full justify-center items-center relative">--}%
     ...
     <img src="${resource(dir: 'images', file: 'assets/branches-of-science/striped_circle.png')}" style="position: absolute; transform: translate(100px, 100px);" />
      <img src="${resource(dir: 'images', file: 'assets/branches-of-science/center_circle.png')}" style="position: absolute; transform: translate(100px, 100px);" />
