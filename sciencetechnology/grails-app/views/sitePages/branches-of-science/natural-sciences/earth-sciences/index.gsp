...
<html lang="en">
  <head>
    ...
    <style>
      .bg-full {
        background-image: url("${resource(dir: 'images', file: 'assets/natural-sciences/earth-sciences/background.png')}");
...
<body class="bg-full h-screen max-w-screen">
    ...
    <div class="flex flex-col justify-between min-h-[calc(100vh-64px)] px-8">
      <div class="pt-8">
      <img src="${resource(dir: 'images', file: 'assets/natural-sciences/earth-sciences/title_sanskrit.png')}" />
      <img src="${resource(dir: 'images', file: 'assets/natural-sciences/earth-sciences/title.png')}" />
      </div>
      <div class="flex justify-between flex-wrap gap-4">
        ...
        <div class="flex justify-evenly flex-wrap items-end mb-4">
          ...
          <img
            ...
            onclick="window.location.href = '${createLink(controller: 'search', action: 'results', params: [categoryFkId: 16, docType: 2])}'"
          />
          <img
            ...
            onclick="window.location.href = '${createLink(controller: 'search', action: 'results', params: [categoryFkId: 16, docType: 1])}'"
          />
          <img
            ...
            onclick="window.location.href = '${createLink(controller: 'search', action: 'results', params: [categoryFkId: 16, docType: 3])}'"
          />
        </div>
      </div>
    </div>
