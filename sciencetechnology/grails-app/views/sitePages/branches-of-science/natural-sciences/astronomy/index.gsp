...
<html lang="en">
  <head>
    ...
    <style>
      .bg-full {
        background-image: url("${resource(dir: 'images', file: 'assets/natural-sciences/astronomy/background.png')}");
...
<body class="bg-full h-screen max-w-screen">
    ...
    <%-- <nav class="flex justify-end p-4 pr-8 text-[#646464] bg-[#A6C4FF] gap-4"> --%>
      ...
      <div
        ...
        title="hint: try login with user - guest@maildrop.cc and password - guest"
      >
    ...
    <div class="flex flex-col justify-between min-h-[calc(100vh-64px)] px-8">
      <div class="pt-8">
      <img src="${resource(dir: 'images', file: 'assets/natural-sciences/astronomy/title_sanskrit.png')}" />
      <img src="${resource(dir: 'images', file: 'assets/natural-sciences/astronomy/title.png')}" />
      </div>
      <div class="flex justify-between flex-wrap gap-4">
        <p class="text-white text-bold text-3xl max-w-2xl">
          ...
          to astronomy appear in the Rig Veda dating back to Vedic times. Sages
        ...
        <div class="flex justify-evenly flex-wrap items-end mb-4">
          ...
          <img
            ...
            onclick="window.location.href = '${createLink(controller: 'search', action: 'results', params: [categoryFkId: 9, docType: 2])}'"
          />
          <img
            ...
            onclick="window.location.href = '${createLink(controller: 'search', action: 'results', params: [categoryFkId: 9, docType: 1])}'"
          />
          <img
            ...
            onclick="window.location.href = '${createLink(controller: 'search', action: 'results', params: [categoryFkId: 9, docType: 3])}'"
          />
        </div>
      </div>
    </div>
