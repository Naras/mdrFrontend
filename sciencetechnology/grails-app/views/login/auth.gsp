...
<nav class="navbar navbar-default navbar-transparent navbar-fixed-top navbar-color-on-scroll" color-on-scroll=" " id="sectionsNav">
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            %{--<ul>
                 <li><a href="http://samskritifoundation.org/" target="_blank">  About Samskriti Foundation </a></li>
            ...
            <div style="color: black; font-size: 30px;font-weight: 500;">
                ...
                <a href="http://samskritifoundation.org/" target="_blank">
                    <img style="background-color: #0001FB;height: 40px;" src="${resource(dir: 'images', file: 'logo_right.png')}" alt="Samskriti" title="Samskriti Foundation" class="img-responsive" />
                    <span>Samskriti</span>
                </a></div>
