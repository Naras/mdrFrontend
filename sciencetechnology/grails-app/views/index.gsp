    ...
    <div class="container">
        ...
        <div style="color: black; font-size: 30px;font-weight: 500;">
            ...
            <div class="flex justify-between p-4">
                <img src="${resource(dir: 'images', file: 'logo_left.png')}" alt="Enter" title="Home"  />
                <img src="${resource(dir: 'images', file: 'logo_middle.png')}" alt="Enter" title="Home" />
                <img src="${resource(dir: 'images', file: 'logo_right.png')}" alt="Enter" title="Home"  />
            </div>
            <div class="flex flex-col items-center mb-4">
                <img src="${resource(dir: 'images', file: 'text_top.png')}" alt="Enter" title="Home" />
                <img src="${resource(dir: 'images', file: 'text_center.png')}" alt="Enter" title="Home" />
                <img src="${resource(dir: 'images', file: 'text_bottom.png')}" alt="Enter" title="Home" />
            </div>
            <div> <img src="${resource(dir: 'images', file: 'sadhu_bottom_left.png')}" alt="Enter" title="Home" class="absolute left-0 bottom-0 h-[300px]" />

            <div class="w-auto absolute right-0 bottom-0 p-4">
            <div class="flex flex-col items-center">
                <g:link controller="login" action="auth">Login</g:link>
                <div> <img src="${resource(dir: 'images', file: 'enter_top.png')}" alt="Enter" title="Home" /></div>
                <div> <g:link controller="sitePages" action="branchesOfScience"><img style="cursor-pointer" src="${resource(dir: 'images', file: 'enter_button.png')}" alt="Enter" title="Branches" /></g:link></div>
            </div></div>
            <div> <img src="${resource(dir: 'images', file: 'grantas_books.png')}" alt="Enter" title="Home" class="absolute left-0 right-0 bottom-0 h-[300px] mx-auto" /></div>
        </div>
    </div>
</nav>
